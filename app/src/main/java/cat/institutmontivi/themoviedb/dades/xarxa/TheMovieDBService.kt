...
interface TheMovieDBService {
    @GET("movie/popular")
    suspend fun getPelisPopularsString(
        @Query("api_key") apikey: String= theMovieDBClient.API_KEY,
        @Query("page") page: Int = 1,
        @Query("language") language: String = "ca-ES"
    ): String

    @GET("movie/popular")
    suspend fun getPelisPopulars(
        @Query("api_key") apikey: String= theMovieDBClient.API_KEY,
        @Query("page") page: Int = 1,
        @Query("language") language: String = "ca-ES"
    ): ApiRespostaGetPopulars

    @GET("movie/{movie_id}/credits")
    suspend fun getActorsPeli(
        @Path("movie_id") filmId: Int,
        @Query("language") language: String = "ca-ES",
        @Query("api_key") apiKey: String = theMovieDBClient.API_KEY
    ): ApiRespostaGetActorsDUnaPeli
